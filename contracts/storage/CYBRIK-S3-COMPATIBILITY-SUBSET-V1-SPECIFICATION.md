...
* **Part & Object Size Thresholds**:
  * **Strict Non-Negative Integer Requirement**: Part sizes MUST be strictly non-negative integers. Negative part sizes, non-integer values, or string-encoded sizes MUST be rejected with HTTP 400 `<Code>InvalidPart</Code>` / `<Code>InvalidArgument</Code>`.
