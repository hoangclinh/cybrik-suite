...
**PROPOSED — NOT ACCEPTED — NOT IMPLEMENTED** successor design packet for the two F8 runtime
...
and grants no signer, ledger, runtime, UAT, release, deployment, or production authority.
