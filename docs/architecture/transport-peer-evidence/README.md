...
2. a server-specific adapter emits the proposed evidence object;
...
`cybrik-soc-command-center:services/api/src/cybrik_soc/modules/ai/client.py`; this proposal changes no
SOC bytes. The AI resolver seam is documented at
`cybrik-cyber-ai-platform:services/ai-api/src/cybrik_ai_api/transport_security.py`; this proposal
