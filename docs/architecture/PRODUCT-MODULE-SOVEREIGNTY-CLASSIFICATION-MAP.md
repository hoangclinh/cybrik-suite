...
| `services/ai-worker/ (pyproject.toml, src/cybrik_ai_worker/__init__.py, py.typed)` | `GOVERNANCE_OR_DOCUMENTATION` | `SCAFFOLD` | Async background worker package scaffold; unpopulated at RC1. |
| `tests/, .github/` | `SUPPORTING_TOOLING_OR_TEST` | `IMPLEMENTED` | Unit, contract, and lifecycle test suites and CI workflows. |
| `packages/**/__init__.py, services/**/__init__.py` | `GOVERNANCE_OR_DOCUMENTATION` | `IMPLEMENTED` | Python package namespace initialization and module markers. |
...
| `services/api/src/cybrik_soc/**/__init__.py, ops/**/__init__.py` | `GOVERNANCE_OR_DOCUMENTATION` | `IMPLEMENTED` | Python package markers and namespace initialization files across backend services (excluding executable registry entrypoints). |
