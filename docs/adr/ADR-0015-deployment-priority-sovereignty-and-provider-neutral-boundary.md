...
| `OPEN-6` | `VIRTUALIZATION_SUBSTRATE_SELECTION` | **RESOLVED_BY_FOUNDER_SELECTION** (`TIERED_SOVEREIGN_VIRTUALIZATION_SUBSTRATE_MODEL` — Linux KVM/QEMU base + Bare-Metal; Proxmox VE optional HCI profile; Firecracker/Cloud-Hypervisor optional microVM sandbox adapters; documented in `docs/adr/FOUNDER-DECISION-PACKET-OPEN-6-OPEN-7-OPEN-8-ACCEPTANCE-2026-09-02.md`) | A separate bounded technology-selection decision |
| `OPEN-7` | `KUBERNETES_DISTRIBUTION_SELECTION` | **RESOLVED_BY_FOUNDER_SELECTION** (`TIER_DIFFERENTIATED_KUBERNETES_PROFILE` — K8s optional/profile-dependent; k3s preferred for T0 if K8s required; RKE2 primary standard for T1/T2; foreign public cloud deferred; documented in `docs/adr/FOUNDER-DECISION-PACKET-OPEN-6-OPEN-7-OPEN-8-ACCEPTANCE-2026-09-02.md`) | A separate bounded technology-selection decision |
| `OPEN-8` | `PROVIDER_SELECTION_AUTHORITY_MODEL` — who holds delegated selection authority, and under what bound | **RESOLVED_BY_FOUNDER_SELECTION** (`HIERARCHICAL_SOVEREIGN_AUTHORITY_MODEL` — Tier 1 Founder Sovereign Envelope -> Tier 2 Signed Operator Policy -> Tier 3 OPEN-5 Ephemeral Capability Lease; fail-closed intersection; documented in `docs/adr/FOUNDER-DECISION-PACKET-OPEN-6-OPEN-7-OPEN-8-ACCEPTANCE-2026-09-02.md`) | A delegation record; §9 fixes the *record format*, not the *delegate* |
